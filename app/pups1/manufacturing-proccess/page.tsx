            ...
            <ol className={styles.list}>
                ...
                <li>
                    ...
                    <p>
                        ...
                        системи складають 150x162х90 міліметрів.
                    </p>
                    <p>
                ...
                <li>
                    ...
                    <p>З`єднання зарядної станції наведено на фотографії нижче:</p>
                    <img
                        src="/pups1/pups1-into.jpeg"
                        alt="Розробка входів та виходів"
                    />
                </li>
                <br />
                <p>
